...
const CheckOutPagePageMain: FC<CheckOutPagePageMainProps> = ({
  ...
  const handleRazorpayPayment = async (amount: string, orderId: string, booking: any) => {
    ...
    const options = {
      ...
      order_id: orderId,
      callback_url: `https://tickyourlist.com/pay-done/`,
      prefill: {
  ...
  // const handleRazorpayPayment = async (amount: string, orderId: string) => {
  //   console.log("anount and data ", amount, orderId)
  //   const options = {
  //     key: "rzp_test_z6uUpQgKfZrule", // Enter the Key ID generated from Razorpay Dashboard
  //     amount: Number(amount) * 100, // Amount in paisa (so multiply the actual amount by 100)
  //     currency: "INR",
  //     name: "Your Company Name",
  //     description: "Booking for XYZ",
  //     image: "https://tickyourlist-images.s3.ap-south-1.amazonaws.com/tyllogo.png",
  //     order_id: orderId, // This is the order ID generated by your backend
  ...
  //         const verifyResponse = await fetch("https://api.univolenitsolutions.com/v1/tyltourcustomerbooking/razorpay/payment-confirmation", {
  //           method: "POST",
  //           headers: {
  ...
  //     alert("Payment service is currently unavailable. Please try again later or use a different payment method.");
  //     // Optionally, redirect or provide an alternative payment method
  //   }
  // };
