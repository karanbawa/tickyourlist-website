...
const widgetMenus: WidgetFooterMenu[] = [
  ...
  },
  {
    ...
    title: "Top Places",
    menus: [
      { href: "/things-to-do-city/dubai/", label: "Dubai" },
      { href: "/things-to-do-city/abu_dhabi/", label: "Abu Dhabi" },
      { href: "/things-to-do-city/singapore/", label: "Singapore" },
      { href: "/things-to-do-city/thailand/", label: "Thailand" },
      { href: "/things-to-do-city/riyad/", label: "Riyad" },
      { href: "/things-to-do-city/maldives/", label: "Maldives" },
      { href: "/things-to-do-city/bali/", label: "Bali" },
      { href: "/things-to-do-city/india/", label: "India" },
      // { href: "#", label: "+ 148 more" },
    ],
  },
  {
